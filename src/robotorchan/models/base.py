...
class NonGPModelMixin(SupervisedTrainingDataMixin, FittableModelMixin):
    ...
    Non-GP models use an explicit fitting procedure rather than a GPyTorch
    marginal likelihood. Concrete models must implement fit and BoTorch\'s
    posterior contract. supports_input_gradients reports whether posterior
    samples preserve autograd with respect to candidate inputs.
    """
