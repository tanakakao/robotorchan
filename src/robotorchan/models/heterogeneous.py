...
from robotorchan.models.base import ModelTrainingMixin, RawDataMixin, _normalize_cat_dims
...
class MixedHeterogeneousMTGP(HeterogeneousMTGP):
    ...
    def __init__(
        ...
        normalized_cat_dims = tuple(
            _normalize_cat_dims(cat_dims=cat_dims, input_dim=full_feature_dim)
        )
        super().__init__(
            train_Xs=train_Xs,
            train_Ys=train_Ys,
