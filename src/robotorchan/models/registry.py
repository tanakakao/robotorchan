        ...
        MODEL_REGISTRY.setdefault(
            ...
            ModelRegistryEntry(
                ...
                ModelCapabilities(
                    ...
                    task_type=TaskType.MULTITASK
                    if ("MultiTask" in name or name in {"HeterogeneousMTGP", "MixedHeterogeneousMTGP"})
...
_register_family(
    ...
    guide="docs/models/standard.md", theory="docs/theory/06_multi_fidelity.md",
...
_register_family(
    ...
    guide="docs/models/standard.md", theory="docs/theory/09_variational_gp.md",
    notebook="examples/notebooks/06_variational_gp.ipynb", strategy="mixed variational GP",
)
_register_family(
    ("MultiTaskGP", "MixedMultiTaskGP", "MixedKroneckerMultiTaskGP", "ModelListGP"),
    guide="docs/models/multitask_multioutput.md", theory="docs/theory/07_multitask_multioutput.md",
    notebook="examples/notebooks/04_multitask_gp.ipynb", strategy="multitask or multi-output GP",
)
_register_family(
    ("SaasFullyBayesianSingleTaskGP", "SaasFullyBayesianMultiTaskGP",
     "MixedSaasFullyBayesianSingleTaskGP"),
    guide="docs/models/high_dimensional.md", theory="docs/theory/21_advanced_high_dimensional_models.md",
    notebook="examples/notebooks/08_saas_gp.ipynb", strategy="fully Bayesian SAAS GP",
    high_dimensional=HighDimensionalStrategy.SAAS,
)
_register_family(
    ...
    guide="docs/models/high_dimensional.md", theory="docs/theory/21_advanced_high_dimensional_models.md",
    notebook="examples/notebooks/09_map_saas_and_additive_gp.ipynb", strategy="MAP-SAAS GP",
...
_register_family(
    ...
    notebook="examples/notebooks/09_map_saas_and_additive_gp.ipynb", strategy="ALEBO random embedding",
    high_dimensional=HighDimensionalStrategy.RANDOM_EMBEDDING,
)
_register_family(
    ("OrthogonalAdditiveGP", "MixedOrthogonalAdditiveGP"),
    guide="docs/models/high_dimensional.md", theory="docs/theory/21_advanced_high_dimensional_models.md",
    notebook="examples/notebooks/09_map_saas_and_additive_gp.ipynb", strategy="orthogonal additive GP",
    high_dimensional=HighDimensionalStrategy.ADDITIVE,
)

_REDUCED = (
    "ReducedGP", "PCAGP", "PLSGP", "RandomProjectionGP", "OutputPCAGP", "OutputPLSGP",
...
_register_family(
    _REDUCED, guide="docs/models/reduced.md", theory="docs/theory/18_dimensionality_reduction_gp.md",
    notebook="examples/notebooks/19_reduced_gp.ipynb", strategy="explicit dimensionality reduction GP",
    high_dimensional=HighDimensionalStrategy.REDUCTION,
)
_NEURAL_REDUCED = (
    "AutoEncoderGP", "VAEGP", "SupervisedAutoEncoderGP", "SupervisedVAEGP", "HybridAutoEncoderGP",
...
_register_family(
    _NEURAL_REDUCED, guide="docs/models/reduced.md", theory="docs/theory/19_neural_reduction_gp.md",
    notebook="examples/notebooks/20_neural_reduction_gp.ipynb", strategy="neural dimensionality reduction GP",
...
_register_family(
    ...
    guide="docs/models/robust_noise.md", theory="docs/theory/14_robust_gaussian_process.md",
    notebook="examples/notebooks/10_robust_gp.ipynb", strategy="robust relevance-pursuit GP",
    robustness=frozenset({RobustnessType.RELEVANCE_PURSUIT}),
)
_register_family(
    ...
    guide="docs/models/robust_noise.md", theory="docs/theory/14_robust_gaussian_process.md",
    notebook="examples/notebooks/15_robust_observation_models.ipynb", strategy="contaminated-observation GP",
...
_register_family(
    ...
    guide="docs/models/robust_noise.md", theory="docs/theory/14_robust_gaussian_process.md",
    notebook="examples/notebooks/15_robust_observation_models.ipynb", strategy="Student-t robust GP",
    robustness=frozenset({RobustnessType.STUDENT_T}),
)
_register_family(
    ("HeteroskedasticSingleTaskGP", "HeteroskedasticMultiTaskGP", "MixedHeteroskedasticSingleTaskGP",
    ...
    guide="docs/models/robust_noise.md", theory="docs/theory/15_heteroskedastic_noise.md",
    notebook="examples/notebooks/16_noise_models.ipynb", strategy="heteroskedastic or replicate-noise GP",
...
_register_family(
    ...
    guide="docs/models/robust_noise.md", theory="docs/theory/17_nonstationary_gp.md",
    notebook="examples/notebooks/18_nonstationary_gp.ipynb", strategy="nonstationary GP",
    robustness=frozenset({RobustnessType.NONSTATIONARY}),
)
_register_family(
    ("UncertainInputSingleTaskGP", "MixedUncertainInputSingleTaskGP", "UncertainCategoricalSingleTaskGP"),
    guide="docs/models/uncertain_input.md", theory="docs/theory/16_uncertain_input_gp.md",
    notebook="examples/notebooks/17_uncertain_input_gp.ipynb", strategy="uncertain-input GP",
...
_register_family(
    ...
    guide="docs/models/structured_output.md", theory="docs/theory/11_structured_output.md",
    notebook="examples/notebooks/11_structured_output_gp.ipynb", strategy="structured-output GP",
...
_register_family(
    ...
    guide="docs/models/multitask_multioutput.md", theory="docs/theory/07_multitask_multioutput.md",
    notebook="examples/notebooks/13_heterogeneous_multitask_gp.ipynb", strategy="structured multitask GP",
)
_register_family(
    ("HierarchicalConditionalKernelGP", "MixedHierarchicalConditionalKernelGP", "LCEAGP", "LCEMGP",
     "MixedLCEMGP", "SACGP"),
    guide="docs/models/hierarchical_contextual.md", theory="docs/theory/12_hierarchical_contextual_gp.md",
    notebook="examples/notebooks/14_contextual_gp.ipynb", strategy="hierarchical or contextual GP",
)
_register_family(
    ("PairwiseGP",), guide="docs/models/preference.md", theory="docs/theory/10_preference_learning.md",
    notebook="examples/notebooks/07_pairwise_gp.ipynb", strategy="pairwise preference GP", preference=True,
)

_register_family(
    ("SingleTaskDeepGP", "MultiTaskDeepGP", "MixedSingleTaskDeepGP", "MixedMultiTaskDeepGP"),
    guide="docs/models/expressive.md", theory="docs/theory/22_expressive_gp.md",
    notebook="examples/notebooks/24_expressive_surrogate_gp.ipynb", strategy="deep GP",
...
_register_family(
    ...
    guide="docs/models/expressive.md", theory="docs/theory/22_expressive_gp.md",
    notebook="examples/notebooks/24_expressive_surrogate_gp.ipynb", strategy="expressive GP surrogate",
)
_register_family(
    ("RandomForestSurrogate", "ExtraTreesSurrogate", "GradientBoostingSurrogate",
     "HistGradientBoostingSurrogate"),
    guide="docs/models/non_gp.md", theory="docs/theory/23_non_gp_surrogates.md",
    notebook="examples/notebooks/25_non_gp_surrogates.ipynb", strategy="non-GP tree ensemble surrogate",
    non_gp=True,
)
