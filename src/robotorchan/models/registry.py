...
MODEL_REGISTRY: dict[str, ModelRegistryEntry] = {
    ...
    "PLSMultiFidelityGP": ModelRegistryEntry(
        "PLSMultiFidelityGP",
        ModelCapabilities(
            high_dimensional=HighDimensionalStrategy.REDUCTION,
            multi_fidelity=True,
        ...
        "PLS design reduction with BoTorch multi-fidelity covariance",
    ),
    "RandomProjectionMultiFidelityGP": ModelRegistryEntry(
    ...
    "HeteroskedasticKroneckerMultiTaskGP": ModelRegistryEntry(
        ...
        "block-design Kronecker multitask GP with task-specific heteroskedastic noise",
    ),
