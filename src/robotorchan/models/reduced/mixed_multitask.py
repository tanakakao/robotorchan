...
class MixedReducedMultiTaskGP(MixedMultiTaskGP):
    ...
    def __init__(
        ...
        *,
        ...
        cats = normalize_feature_dims(cat_dims, input_dim, name="cat_dims", excluded_dims=[task_dim])
    ...
    def _prepare_inputs(self, X: Tensor) -> Tensor:
        ...
        task = X[..., self.original_task_feature : self.original_task_feature + 1].to(reduced_data_X)
