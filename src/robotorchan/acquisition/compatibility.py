...
def check_model_acquisition_compatibility(
    ...
    if (
        ...
        and acquisition_capabilities.posterior_requirement
        is not PosteriorRequirement.MARGINAL_MOMENTS
    ):
        reasons.append(
            "non-GP models require either marginal-moment AL or BoTorch Monte Carlo acquisitions"
        )
